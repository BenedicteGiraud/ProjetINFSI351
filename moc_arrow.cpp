...
static const char qt_meta_stringdata_Arrow[] = {
    "Arrow\0\0name\0click(QString)\0"
};
...
const QMetaObjectExtraData Arrow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Arrow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Arrow,
      qt_meta_data_Arrow, &staticMetaObjectExtraData }
};
