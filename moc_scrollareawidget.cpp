...
static const char qt_meta_stringdata_ScrollAreaWidget[] = {
    "ScrollAreaWidget\0\0dx\0scrolling(int)\0"
};
...
void ScrollAreaWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        ScrollAreaWidget *_t = static_cast<ScrollAreaWidget *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData ScrollAreaWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ScrollAreaWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ScrollAreaWidget,
      qt_meta_data_ScrollAreaWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ScrollAreaWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ScrollAreaWidget))
...
// SIGNAL 0
void ScrollAreaWidget::scrolling(int _t1)
{
